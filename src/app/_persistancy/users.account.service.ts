...
export var GUser: IUserModel | undefined = undefined;

export const GIUserAdmin: IUserModel = new UserModel({
  sysname: 'admin',
  password: '1111',
  name: 'admin bikebox',
...
export class UsersAccountService {
  private readonly mapUsers: Map<string, UserModel> = new Map<
    string,
    UserModel
  >();
  ...
  public user$: BehaviorSubject<IUserModel | undefined> = new BehaviorSubject(
    GUser
  );
  ...
  async saveUser$(user: IUserModel, persist: boolean) {
